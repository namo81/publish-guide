...
function timelineFunc(option) {
    ...
    let wrapClass = this.timeline,
        ...
        lineWidth = timeline.parentNode.offsetWidth,
        recArr = new Array(),
    ...
    */
        ...
        if(tx == true) {
            ...
            for(let n=startNum; n<endVal; n+=forGap){
                if((n%totalSec)%timeGap == restNum) {
                    let t = n - startVal,
                        tx = secToVal(n, 'hh:mm');
                    arr[0].push(lineWidth * (t/totalSec));
                    arr[1].push(tx);
    ...
    tickWrap.insertAdjacentHTML('afterbegin', '<g class="tick-bar prev"></g>');
    tickWrap.insertAdjacentHTML('afterbegin', '<g class="tick-bar center"></g>');
    tickWrap.insertAdjacentHTML('afterbegin', '<g class="tick-bar next"></g>');
    ...
    marksWrap.insertAdjacentHTML('afterbegin', '<g class="marks prev"></g>');
    marksWrap.insertAdjacentHTML('afterbegin', '<g class="marks center"></g>');
    marksWrap.insertAdjacentHTML('afterbegin', '<g class="marks next"></g>');
    ...
    drawBar = function(bar, sv, ev){
        ...
        bar.insertAdjacentHTML('afterbegin', '<g class="tick-area"></g>');
        bar.insertAdjacentHTML('afterbegin', '<g class="sTick-area"></g>');
